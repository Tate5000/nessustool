# -*- coding: utf-8 -*-
u"""
nessus file analyzer (pronounced *ˈlɪm.bɚ dʌk*) is a GUI
...
__title__ = "nessus file analyzer"
__package_name__ = "nessus-file-analyzer"
__icon__ = "LimberDuck-nessus-file-analyzer.ico"
__summary__ = "nessus file analyzer is a GUI tool which enables you to parse nessus scan files from " \
              "Nessus and Tenable.SC by (C) Tenable, Inc. and exports results to a Microsoft Excel Workbook for " \
              "effortless analysis."
__uri__ = "https://aegisai.info"
__version__ = "0.7.2"
__release_date__ = "2022.05.13"
__author__ = u"Tate Carroll"
__email__ = "tate@aegisai.info"
